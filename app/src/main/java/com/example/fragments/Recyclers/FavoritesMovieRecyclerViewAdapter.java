...
public class FavoritesMovieRecyclerViewAdapter extends RecyclerView.Adapter<FavoritesMovieRecyclerViewAdapter.ViewHolder> {
    private ArrayList<Film> arrayMovies;
    private Context context;

    public FavoritesMovieRecyclerViewAdapter(ArrayList<Film> arrN, Context c){
